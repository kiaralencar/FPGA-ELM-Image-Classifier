// Modulo principal, instancia e conecta demais modulos
module elm_accel (
    input wire clk,
    input wire reset,
...
// Instancia da FSM de inferencia
fsm_infer u_fsm (
    .clk (clk),
    .reset (reset),
    .start (start_infer),
