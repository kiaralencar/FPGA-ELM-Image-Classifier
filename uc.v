// Modulo que decodifica as instruções (nossa ISA) da placa com o sistema interno (memorias + FSM)
module uc (
    input wire clk,
    input wire reset,
...
/* Opcodes das instruções para escrita manual da memoria:
0001 - Acessa memoria da imagem
0010 - Acessa memoria dos win
0011 - Acessa memoria dos bias
0110 - Acessa memoria dos betas */
localparam OP_MEM_IMG  = 4'd1;
localparam OP_MEM_WIN  = 4'd2;
localparam OP_MEM_BIAS = 4'd3;
localparam OP_MEM_BETA = 4'd6;

// Estados do co-processador devolvidos pela instrução de STATUS
localparam ST_READY = 2'b00;
localparam ST_BUSY  = 2'b01;
localparam ST_DONE  = 2'b10;
localparam ST_ERROR = 2'b11;

// Registradores internos — fluxo normal
...
// Registradores internos — escrita manual
reg [9:0] mw_img_addr;
reg [7:0] mw_img_data;
reg mw_img_wr_en;
